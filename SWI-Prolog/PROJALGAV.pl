...
agenda_staff(d019, 20241028, []).
agenda_staff(d020, 20241028, []).
...
surgery(so3,45,60,45).
surgery(so4,45,60,45).
...
availability_all_surgeries([OpCode|LOpCode],Room,Day):-
    ...
    append(ListOfStaffsAnesthesia,ListOfStaffsAssistant,ListOfStaffsAnesthesiaAssistant),
    append(ListOfStaffsAnesthesiaAssistant,ListOfStaffsSurgery,ListOfStaffsAll),
    intersect_all_agendas(ListOfStaffsAll,Day,StaffFreeTime),
    intersect_2_agendas(StaffFreeTime,LRoomAvailability,FreeTimeForBoth),

    schedule_first_interval(TotalTime,FreeTimeForBoth,(TinS,TfinS)),

    % Aneasthesia Doctors verification
    TimeFinalForAnaesthesia is TinS + TAnesthesia + TSurgery - 1,
    availability_Anaesthesia(Day,AneasthesiaTime,ListOfStaffsAnesthesia,(TinS,TimeFinalForAnaesthesia)),

    % Surgery Doctors verification
    SurgeryIntialTIme is TinS + TAnesthesia,
    availability_Surgery(Day,SurgeryTime,ListOfStaffsSurgery,(SurgeryIntialTIme,TimeFinalForAnaesthesia)),
    ...
    availability_Cleaning(Day,CleaningTime,ListOfStaffsAssistant,(TInitialForCleaning,TimeFinalForCleaning)),
        ...
        %write('ListOFStaffsAnesthesia='),write(ListOfStaffsAnesthesia),nl,
        %write('SurgeryTime='),write(SurgeryTime),nl,
        %write('ListOfStaffsSurgery='),write(ListOfStaffsSurgery),nl,
        %write('CleaningTime='),write(CleaningTime),nl,
        %write('ListOfStaffsAssistant='),write(ListOfStaffsAssistant),nl,
        %write('XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'),nl,
    ...
    addOpCodeToFormat(AneasthesiaTime,OpCode,NewFormat),
    insert_agenda_doctors(NewFormat,Day,ListOfStaffsAnesthesia),

    addOpCodeToFormat(SurgeryTime,OpCode,NewFormat2),
    insert_agenda_doctors(NewFormat2,Day,ListOfStaffsSurgery),

    addOpCodeToFormat(CleaningTime,OpCode,NewFormat3),
...
availability_Anaesthesia(Day,Result,ListOfStaffsAnesthesia,(TinS,TfinS)):-
    intersect_all_agendas(ListOfStaffsAnesthesia,Day,StaffFreeTime),
    write('StaffFreeTime='),write(StaffFreeTime),nl,
    write('ListOfStaffsAnesthesia='),write(ListOfStaffsAnesthesia),nl,
    intersect_2_agendas(StaffFreeTime,[(TinS,TfinS)],Result).

availability_Cleaning(Day,Result,ListOfStaffsCleaning,(TinS,TfinS)):-
    intersect_all_agendas(ListOfStaffsCleaning,Day,StaffFreeTime),
      write('StaffFreeTime='),write(StaffFreeTime),nl,
    write('ListOfStaffsCleaning='),write(ListOfStaffsCleaning),nl,
    intersect_2_agendas(StaffFreeTime,[(TinS,TfinS)],Result).

availability_Surgery(Day,Result,ListOfStaffsSurgery,(TinS,TfinS)):-
