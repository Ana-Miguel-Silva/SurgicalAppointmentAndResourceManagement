...
**US 7.2.18** As a Doctor, I want to update an medical condition entry in a medical record
...
**Domain Class/es:** Medical Conditon, Medical Record
...
**Update Medical Condition Level 1**

![Update Medical Condition](sequence-diagram-1.svg "Update Medical Condition")

**Update Medical Condition Level 2**

![Update Medical Condition](sequence-diagram-2.svg "Update Medical Condition")

**Update Medical Condition Level 3 FrontEnd**

![Update Medical Condition](sequence-diagram-3.svg "Update Medical Condition")

**Update Medical Condition Level 3 BackEnd**

![Update Medical Condition](sequence-diagram-3-BE.svg "Update Medical Condition")
