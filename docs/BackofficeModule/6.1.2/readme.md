...
As part of the development of the software system, it is necessary to implement user management functionalities within the administrative interface. These functionalities are essential to allow users to have a acess to their funtionalities, according to their role.
