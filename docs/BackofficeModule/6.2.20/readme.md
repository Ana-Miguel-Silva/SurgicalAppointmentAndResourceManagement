...
**Deactivate Operation Type Level 1**

![Deactivate Operation Type](sequence-diagram-1.svg "Deactivate Operation Type")

**Deactivate Operation Type Level 2**

![Deactivate Operation Type](sequence-diagram-2.svg "Deactivate Operation Type")

**Deactivate Operation Type UI Level 3**

![Deactivate Operation Type](sequence-diagram-3.svg "Deactivate Operation Type")
