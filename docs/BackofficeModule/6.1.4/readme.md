...
As part of the development of the software system, it is necessary to implement user management functionalities that ensure that information between the two modules is kept in sync.
...
- Information used in the Planning Module is synchronized with the one in the Backoffice Module
